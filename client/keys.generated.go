...
const (
	// ----- content types ----
	codecSelferCcUTF87866 = 1
	codecSelferCcRAW7866  = 0
	// ----- value types used ----
	codecSelferValueTypeArray7866  = 10
	codecSelferValueTypeMap7866    = 9
	codecSelferValueTypeString7866 = 6
	codecSelferValueTypeInt7866    = 2
	codecSelferValueTypeUint7866   = 3
	codecSelferValueTypeFloat7866  = 4
	codecSelferBitsize7866         = uint8(32 << (^uint(0) >> 63))
)

var (
	errCodecSelferOnlyMapOrArrayEncodeToStruct7866 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer7866 struct{}
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87866, `errorCode`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeInt(int64(x.Code))
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferCcUTF87866, string(x.Message))
				}
			} else {
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87866, `message`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeString(codecSelferCcUTF87866, string(x.Message))
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferCcUTF87866, string(x.Cause))
				}
			} else {
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87866, `cause`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeString(codecSelferCcUTF87866, string(x.Cause))
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87866, `index`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeUint(uint64(x.Index))
...
func (x *Error) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if false {
		...
		if yyct2 == codecSelferValueTypeMap7866 {
			yyl2 := r.ReadMapStart()
			if yyl2 == 0 {
				r.ReadMapEnd()
			} else {
		...
		} else if yyct2 == codecSelferValueTypeArray7866 {
			...
			panic(errCodecSelferOnlyMapOrArrayEncodeToStruct7866)
		}
	}
}
	...
	for yyj3 := 0; ; yyj3++ {
		...
		case "errorCode":
			if r.TryDecodeAsNil() {
				...
				x.Code = (int)(z.C.IntV(r.DecodeInt64(), codecSelferBitsize7866))
			}
		case "message":
			if r.TryDecodeAsNil() {
				x.Message = ""
...
func (x PrevExistType) CodecEncodeSelf(e *codec1978.Encoder) {
	...
	if false {
		...
		r.EncodeString(codecSelferCcUTF87866, string(x))
	}
}
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87866, `AfterIndex`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeUint(uint64(x.AfterIndex))
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87866, `Recursive`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeBool(bool(x.Recursive))
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87866, `TTL`)
				r.WriteMapElemValue()
				if false {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferCcUTF87866, string(x.PrevValue))
				}
			} else {
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87866, `PrevValue`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeString(codecSelferCcUTF87866, string(x.PrevValue))
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87866, `PrevIndex`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeUint(uint64(x.PrevIndex))
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87866, `PrevExist`)
				r.WriteMapElemValue()
				x.PrevExist.CodecEncodeSelf(e)
			}
			if yyr2 || yy2arr2 {
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87866, `Refresh`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeBool(bool(x.Refresh))
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87866, `Dir`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeBool(bool(x.Dir))
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87866, `NoValueOnSuccess`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeBool(bool(x.NoValueOnSuccess))
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87866, `Sort`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeBool(bool(x.Sort))
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87866, `Quorum`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeBool(bool(x.Quorum))
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferCcUTF87866, string(x.Action))
				}
			} else {
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87866, `action`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeString(codecSelferCcUTF87866, string(x.Action))
		...
		LABEL6:
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87866, `node`)
				r.WriteMapElemValue()
				if yyn6 {
					r.EncodeNil()
				} else {
		...
		LABEL9:
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87866, `prevNode`)
				r.WriteMapElemValue()
				if yyn9 {
					r.EncodeNil()
				} else {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferCcUTF87866, string(x.Key))
				}
			} else {
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87866, `key`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeString(codecSelferCcUTF87866, string(x.Key))
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferCcUTF87866, string(x.Value))
				}
			} else {
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87866, `value`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeString(codecSelferCcUTF87866, string(x.Value))
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87866, `nodes`)
				r.WriteMapElemValue()
				if x.Nodes == nil {
					r.EncodeNil()
				} else {
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87866, `createdIndex`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeUint(uint64(x.CreatedIndex))
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87866, `modifiedIndex`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeUint(uint64(x.ModifiedIndex))
		...
		LABEL21:
			if yyr2 || yy2arr2 {
				...
				if yyq2[6] {
					r.WriteMapElemKey()
					r.EncodeString(codecSelferCcUTF87866, `expiration`)
					r.WriteMapElemValue()
					if yyn21 {
						r.EncodeNil()
					} else {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferCcUTF87866, string(x.Prefix))
				}
			} else {
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87866, `Prefix`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeString(codecSelferCcUTF87866, string(x.Prefix))
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87866, `Sorted`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeBool(bool(x.Sorted))
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87866, `WaitIndex`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeUint(uint64(x.WaitIndex))
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferCcUTF87866, string(x.Dir))
				}
			} else {
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87866, `Dir`)
...
func (x codecSelfer7866) encNodes(v Nodes, e *codec1978.Encoder) {
	var h codecSelfer7866
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
...
func (x codecSelfer7866) decNodes(v *Nodes, d *codec1978.Decoder) {
	var h codecSelfer7866
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
